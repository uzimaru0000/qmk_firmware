...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP, KC_QUOT , \
      KC_LCTL, ADJUST,  KC_LALT, KC_LGUI, KC_GRV,  KC_SPC,  LOWER,  RAISE,    KC_SPC,  KANA,    KC_SLSH, KC_LEFT, KC_DOWN,   KC_RGHT \
      ),
